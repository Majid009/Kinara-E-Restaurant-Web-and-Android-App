...
<body style="background: #363C33;">
 ...
 <div class="container-fluid">
    ...
    <div class="col-md-4 col-md-offset-4 animated zoomIn" style="margin-top:100px;  text-align:center; color:white;">
			<h1>Login Failed!</h1>
       <p>Please check your email and password. <a href="login-register.php"> <b> Click Here </b> </a> to try again.</p>
			<p><a class="btn btn-primary" style="padding:10px 30px; border-radius:0px;" href="login-register.php">Login</a></p>
		</div>
	 </div>
 </div>
</body>
