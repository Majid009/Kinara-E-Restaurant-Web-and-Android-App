...
<body style="background: #363C33;">
 ...
 <div class="container-fluid">
    ...
    <div class="col-md-4 col-md-offset-4 animated zoomIn" style="margin-top:100px;  text-align:center; color:white;">
			...
			<p>You are seeing this page because Room / Table has been booked already.</p>
			<p><a class="btn btn-primary" style="padding:5px 30px; border-radius:0px;" href="partyhalls.php"> Try Again</a></p>
		</div>
	 </div>
 </div>
</body>
